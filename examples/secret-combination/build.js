var secretcombination = (function () {
'use strict';
...
var filter = lib.curryN(2, function(fn, s) {
  return lib.combine(function(s, self) {
    if (fn(s())) self(s.val);
  }, [s]);
});

var lift = function(f /* , streams */) {
  var streams = Array.prototype.slice.call(arguments, 1);
  var vals = [];
  return lib.combine(function() {
    for (var i = 0; i < streams.length; ++i) vals[i] = streams[i]();
    return f.apply(null, vals);
  }, streams);
};

var inlast = lib.curryN(2, function(dur, s) {
  var values = [];
  return lib.combine(function(s, self) {
    setTimeout(function() {
...
var sampleon = lib.curryN(2, function(s1, s2) {
  return lib.combine(function() {
    return s2();
  }, [s1]);
});
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var correctClicks = lib.reduce(function(n, c) {
  ...
  lib.map(function(c) { console.log('cor', c); }, correctClicks);
  lib.map(function(c) { console.log('lst', c); }, clicksInLast5s);
});
