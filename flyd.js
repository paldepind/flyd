 ...
 * sum(); // 10
 */
flyd.scan = curry3(function(f, acc, s) {
 ...
 */
flyd.merge = curry2(function(s1, s2) {
 ...
 * results; // => [2, 4, 6, 8]
 */
flyd.transduce = curry2(function(xform, source) {
